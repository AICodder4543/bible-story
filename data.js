...
const ERAS = [
  ...
  },
  {
    ...
    chronology: [
      { date: "AD 30", text: "The election of Matthias; Pentecost; the preaching of Peter" },
      { date: "AD 33–34", text: "The imprisonment of Peter and John; numerous miracles and conversions in Jerusalem" },
      { date: "AD 36", text: "The martyrdom of Stephen; persecution of the Church; Philip and the Ethiopian eunuch" },
      { date: "AD 36–37", text: "The conversion of Saul (Paul) on the road to Damascus" },
      { date: "AD 37", text: "The death of Caesar Tiberius; Caligula becomes emperor" },
      { date: "AD 39", text: "Paul visits Jerusalem; miracles of Peter; the conversion of Cornelius" },
      { date: "AD 41", text: "Claudius becomes emperor" },
      { date: "AD 42–43", text: "The martyrdom of James the Greater" },
      { date: "AD 43", text: "The term \"Christian\" is used for the first time in Antioch" },
      { date: "AD 44", text: "The death of Herod Agrippa I; Peter is arrested again" },
      { date: "AD 45–49", text: "The first missionary journey of Paul with Barnabas" },
      { date: "AD 47–49", text: "Famine throughout the empire; Paul and Barnabas take up a collection for the Christians in Jerusalem" },
      { date: "AD 49–50", text: "The Council of Jerusalem" },
      { date: "AD 50–69", text: "The Letter of Jude" },
      { date: "AD 50–53", text: "Paul's second missionary journey" },
      { date: "AD 50–51", text: "Paul preaches in Athens; the First and Second Letters of Paul to the Thessalonians" },
      { date: "AD 52–62", text: "The Letters of Paul to the Galatians, the Philippians, and Philemon" },
      { date: "AD 54", text: "Nero becomes emperor" },
      { date: "AD 56–57", text: "The First and Second Letters of Paul to the Corinthians" },
      { date: "AD 57–58", text: "The Letter of Paul to the Romans" },
      { date: "AD 58", text: "Paul returns to Jerusalem, where he is imprisoned" },
      { date: "AD 60–66", text: "The First and Second Letters of Paul to Timothy; the Letter of Paul to Titus" },
      { date: "AD 60–63", text: "The martyrdom of James, Bishop of Jerusalem; the Letters of Paul to the Colossians and the Ephesians" },
      { date: "AD 60–61", text: "The journey of Paul to Rome" },
      { date: "AD 64–66", text: "The First and Second Letters of Peter; the Letter to the Hebrews" },
      { date: "AD 67", text: "The martyrdom of Peter and Paul in Rome" },
      { date: "AD 69", text: "Vespasian becomes emperor" },
      { date: "AD 70", text: "Jerusalem is destroyed by the Roman army led by Titus" },
      { date: "AD 79", text: "Titus becomes emperor" },
      { date: "AD 50–70", text: "The Gospel of Matthew (Greek); the Gospel of Luke; the Acts of the Apostles" },
      { date: "AD 81", text: "Domitian becomes emperor" },
      { date: "AD 90–100", text: "The Gospel of John; the Letters of John" },
      { date: "AD 95–96", text: "The Book of Revelation; Nerva becomes emperor" },
      { date: "AD 98", text: "Trajan becomes emperor" }
    ],
    events: [
      {
        icon: "🔥",

...
// Each entry is one day's set of 5 questions, ordered from simplest to
// hardest. The site picks a set automatically based on today's date (see
// quiz.js), cycling through this list, so it "auto-updates" daily without
// needing a server.
//
// Add more sets any time — the more sets, the longer before it repeats.

const QUIZ_EPOCH = "2026-07-15"; // Day 0 of the rotation.
